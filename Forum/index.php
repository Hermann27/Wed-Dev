...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Forum CPL Consulting</title>
    </head>
    <body>
    	<div class="header">
...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Forum CPL Consulting</a>
    </div>
	<div class="box_right">
...
{
?>
	<a href="new_category.php" class="button">Nouveau Categorie</a>
<?php
}
?>
...
{
?>
	<a href="new_category.php" class="button">Noveau Categorie</a>
<?php
}
if(!isset($_SESSION['username']))
{
...
<div class="box_login">
    ...
    <input type="password" name="password" id="password" /><br />
        <label for="memorize">Garder votre mot de passe</label><input type="checkbox" name="memorize" id="memorize" value="yes" />
        <div class="center">
