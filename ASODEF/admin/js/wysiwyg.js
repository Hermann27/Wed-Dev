...
var WYSIWYG = {
	...
	"bold":           ['Bold',                 'Gras',               	'bold.gif',               'bold_on.gif'],
	"italic":         ['Italic',               'Italique',             	'italics.gif',            'italics_on.gif'],
	"underline":      ['Underline',            'Souligné',          	'underline.gif',          'underline_on.gif'],
	"strikethrough":  ['Strikethrough',        'Barré',      	'strikethrough.gif',      'strikethrough_on.gif'],
	"seperator":      ['',                     '',                   	'seperator.gif',          'seperator.gif'],
	"subscript":      ['Subscript',            'Exposant',          	'subscript.gif',          'subscript_on.gif'],
	"superscript":    ['Superscript',          'Indice',        	'superscript.gif',        'superscript_on.gif'],
	"justifyleft":    ['Justifyleft',          'Aligné à Gauche',        	'justify_left.gif',       'justify_left_on.gif'],
	"justifycenter":  ['Justifycenter',        'Au Centre',      	'justify_center.gif',     'justify_center_on.gif'],
	"justifyright":   ['Justifyright',         'Aligné à Droite',       	'justify_right.gif',      'justify_right_on.gif'],
	"justifyfull": 	  ['Justifyfull', 		   'Justifier', 			'justify_justify.gif', 	  'justify_justify_on.gif'], 
	"unorderedlist":  ['InsertUnorderedList',  'Puces',	'list_unordered.gif',     'list_unordered_on.gif'],
	"orderedlist":    ['InsertOrderedList',    'Numérotation',  	'list_ordered.gif',       'list_ordered_on.gif'],
	"outdent":        ['Outdent',              'Augmenter Retrait',            	'indent_left.gif',        'indent_left_on.gif'],
	"indent":         ['Indent',               'Diminuer Retrait',             	'indent_right.gif',       'indent_right_on.gif'],
	"cut":            ['Cut',                  'Couper',                	'cut.gif',                'cut_on.gif'],
	"copy":           ['Copy',                 'Copier',               	'copy.gif',               'copy_on.gif'],
	"paste":          ['Paste',                'Coller',              	'paste.gif',              'paste_on.gif'],
	"forecolor":      ['ForeColor',            'Couleur de Police',          	'forecolor.gif',          'forecolor_on.gif'],
	"backcolor":      ['BackColor',            'Couleur de Fond',          	'backcolor.gif',          'backcolor_on.gif'],
	"undo":           ['Undo',                 'Précedent',               	'undo.gif',               'undo_on.gif'],
	"redo":           ['Redo',                 'Suivant',               	'redo.gif',               'redo_on.gif'],
	"inserttable":    ['InsertTable',          'Inserer Tableau',        	'insert_table.gif',       'insert_table_on.gif'],
	"insertimage":    ['InsertImage',          'Inserer Image',        	'insert_picture.gif',     'insert_picture_on.gif'],
	"createlink":     ['CreateLink',           'Créer un Lien',         	'insert_hyperlink.gif',   'insert_hyperlink_on.gif'],
	"viewSource":     ['ViewSource',           'Voir la Source',         	'view_source.gif',        'view_source_on.gif'],
	"viewText":       ['ViewText',             'Voir le Texte',           	'view_text.gif',          'view_text_on.gif'],
	"help":           ['Help',                 'Aide',               	'help.gif',               'help_on.gif'],
	"fonts":     	  ['Fonts',           	   'Choix de la Police',        	'select_font.gif',        'select_font_on.gif'],
	"fontsizes":      ['Fontsizes',            'Choix de la Taille',        	'select_size.gif',        'select_size_on.gif'],
	"headings":       ['Headings',             'Choix de la Taille',        	'select_heading.gif',     'select_heading_on.gif'],
	"preview":		  ['Preview', 			   'Aper&ccedil;u',       	 	'preview.gif',			  'preview_on.gif'],
	"print":		  ['Print', 			   'Imprimer',       	 	 	'print.gif',			  'print_on.gif'],
	"removeformat":   ['RemoveFormat',         'Convertion Word HTML',    	'remove_format.gif',      'remove_format_on.gif'],
	"delete":         ['Delete',               'Supprimer',             	'delete.gif',     		  'delete_on.gif'],
	"save": 		  ['Save', 				   'Enregistrer',         'save.gif', 			  'save_on.gif'],
	"return": 		  ['Return', 			   'Retour Sans Enregistrer', 'return.gif', 			  'return_on.gif'],
	"maximize": 	  ['Maximize', 			   'Agrandir l&sbquo;Editeur',   'maximize.gif', 		  'maximize_on.gif']
	},
...
var WYSIWYG_ContextMenu = {
	...
	output: function (n) {
		...
		// Add items
		this.addItem(n, 'Copy', iconCopy, 'Copier', sel);
		this.addItem(n, 'Cut', iconCut, 'Couper', sel);
		this.addItem(n, 'Paste', iconPaste, 'Coller', true);
		this.addSeperator();
		this.addItem(n, 'InsertImage', iconImage, 'Propriétés de l&rsquo;Image...', isImg);
		this.addItem(n, 'CreateLink', iconLink, 'Créer ou Modifier un Lien...', sel || isLink);
		this.addItem(n, 'RemoveNode', iconDelete, 'Supprimer', true);
