...
<p><img src="images/logo3iac.png" width="98" height="54" /></p>		
		...
		<div id="content-wrap">
			...
			<div id="main">
				...
				<p>			
                <label>Code</label>
				<input name="code" value="" type="text" placeholder=" code promotion" size="30" required="required"/>
                 <label>Année</label>
				<input name="societe" value="" type="text" placeholder="Ex:2013-2014" size="30" required="required"/>
				...
				if(isset($_POST['cnom'],$_POST['cemail'],$_POST['ctexte']))
				{
							...
							@$email = $_POST['cemail'];
							@$texte= $_POST['ctexte'];							
					$querry = "insert into utilisateurs(id,pseudo, password,ismod) 
