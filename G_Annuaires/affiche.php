...
$retour_total=mysql_query('SELECT COUNT(*) AS total FROM commentaires WHERE id_sujet ='.$id_sujet.'')or die(mysql_error());; //Nous récupérons le contenu de la requête dans $retour_total
...
$total=$donnees_total['total']; //On récupère le total pour le placer dans la variable $total.
	...
	?>
		...
		<div id="footer">
		    ...
		    <a href="https://www.waza-solutions.com//" title="NTM-Forum">CPL-forum </a> by <a href="https://www.waza-solutions.com//">CPL Consulting</a>
