...
<p><img src="images/logo3iac.png" width="98" height="54" /></p>		
		...
		<div id="content-wrap">
			...
			<div id="main" style="margin-top:15px;">
                ...
                <table id="table" style="border-collapse:collapse;">
                 ...
                 <tr>
                   <td style="border:1px solid black;">
                     <label for="code">Entreprise*</label>
                     <input name="nom" type="text" placeholder="votre code" size="30" required />                     
                   </td>
                 </tr>
                 <tr>
                   <td style="border:1px solid black;">
                 ...
                 <tr>
                  ...
                  <tr>
                   <td style="border:1px solid black;">
                     ...
                     <input name="date" type="text" placeholder="Ex:30 jours" required />                     
                   </td>
                 </tr>
                 <tr>
                   <td style="border:1px solid black;">
                     <label for="date">Validité*</label>
                     <input name="validite" type="text" placeholder="Ex:30 jours" required />                     
                   </td>
                 </tr>
                </table>	
                ...
                <?php				
				if(isset($_POST['nom'],$_POST['intitule'],$_POST['decrire'],$_POST['type'],$_POST['date']))
				{
							@$IDETS = $_POST['code'];
							@$NOM_ETS=$_POST['nom'];
