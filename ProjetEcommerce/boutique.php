...
<title> CATALOGUE DES MEDICAMENT</title>
<link rel="stylesheet" media="screen" type="text/css" href="file:///C|/xampp/htdocs/ProjetEcommerce/look.css" />
</head>

<body>
	<div class="titre">
    	<a href="file:///C|/xampp/htdocs/ProjetEcommerce/Boutique.php">Boutique DES <i>MEDICAMENTS</i></a>
    </div>
    	...
    	<tr>
            ...
            <td class="detail">
                ...
                <?php
					...
					mysql_close($db);
                ?>
                <form action="file:///C|/xampp/htdocs/ProjetEcommerce/ajout_caddie.php" method="post">
