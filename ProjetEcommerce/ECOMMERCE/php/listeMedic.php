        ...
        <div class="article">
          ...
          <div class="clr"></div> <center>
			...
			<?php
                ...
                $query="select nom,forme,pu from medicament order by nom";
				...
				echo "<form action=\"listeMedic.php\" method=\"post\" id=\"f1\">";
				...
				echo '<tr><td class="rounded-foot-left" colspan="2"><center><input type="submit" value="retour" name="retour" onclick="back()"></center></td><td class="rounded-foot-right" colspan="2"><center><input type="submit" value="Next" name="next"></center></td></tr>';
				echo "</table></p></form>";
				mysql_close($db);
           ?></center>
          <div class="clr"></div>
